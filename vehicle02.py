...
class VehicleModel:
    ...
    def simulate(self, x0, v0, xf, vf, tf, wcrt_delay):
        ...
        return t_values_with_delay, x_values
...
t_values_with_delay, x_values = vehicle_model.simulate(x0, v0, xf, vf, tf, wcrt_delay)

# Plot the trajectory
plt.plot(t_values_with_delay, x_values, label='Vehicle Trajectory (WCRTD)')
plt.xlabel('Time (s)')
